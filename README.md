...
- [Stokowski](#stokowski)
  ...
  - [What is it?](#what-is-it)
    - [How it maps to Symphony](#how-it-maps-to-symphony)
  - [Features](#features)
  ...
  - [Work reports on Linear](#work-reports-on-linear)
  - [Configuration reference](#configuration-reference)
    - [State types](#state-types)
    - [Multi-workflow layout (`workflows:`)](#multi-workflow-layout-workflows)
    - [Per-state runner config](#per-state-runner-config)
      - [Session modes: `inherit` vs `fresh`](#session-modes-inherit-vs-fresh)
      - [What the agent sees: context continuity](#what-the-agent-sees-context-continuity)
  - [Prompt template variables](#prompt-template-variables)
  - [MCP servers](#mcp-servers)
  - [Writing good tickets for agents](#writing-good-tickets-for-agents)
    - [Acceptance criteria JSON](#acceptance-criteria-json)
    - [Using Claude Code to write your tickets](#using-claude-code-to-write-your-tickets)
